...
export function useVibes() {
  ...
  const moods = [
    {
      id: "date romantique",
      label: "Date Romantique",
      emoji: "Group_53.png",
      description: "Lumière tamisée, service discret.",
    },
    {
      id: "jardin secret",
      label: "Jardin Secret",
      emoji: "Group_54.png",
      description: "Terrasses cachées, nature.",
    },
    {
      id: "entre amis",
      label: "Entre Amis",
      emoji: "Group_49.png",
      description: "Généreux, convivial, joyeux.",
    },
    {
      id: "célébration",
      label: "Célébration",
      emoji: "Group_50.png",
      description: "Les plus grandes tables.",
    },
    {
      id: "zen & détox",
      label: "Zen & Détox",
      emoji: "Group_15.png",
      description: "Végétal, léger, minimaliste.",
    },
    {
      id: "custom",
      label: "Sur-mesure",
      emoji: "Group_52.png",
      description: "Décris ton envie du moment.",
    },
  ];
